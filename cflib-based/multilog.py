...
def main():
    ...
    if len(available) == 0:
        ...
        if (small_log):
            logConfig_stab = LogConfig(name='AttitudeBeforePosCtrl', period_in_ms=log_intervall)
            ...
            logConfig_state = LogConfig(name='AttitudeAfterPosCtrl', period_in_ms=log_intervall)
